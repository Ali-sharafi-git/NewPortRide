      ...
      <div className="container mx-auto max-w-6xl py-20 px-5">
        <div className="flex flex-col-reverse lg:flex-row justify-between items-start gap-10">
          <div className="flex-1">
            {!hiddenHeader && (
              <SectionTitle
                title={t("lax_limousine_service")}
                subtitle={t("about_our_company")}
                firstTitle={false}
                size="medium"
            ...
            <p className="text-sm md:text-base text-center md:text-left">
              {t("about_our_company_description")}
            </p>
            <strong className="text-lg font-bold mt-14 block text-center md:text-left mb-5 md:mb-0">
              {t("call_for_a_book")}:
            </strong>
            <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-2.5">
              <div className="flex flex-col">
                <a
                  ...
                  className="text-lg font-bold mb-10 md:mb-0"
                >
                  {websiteInformation.support_number}
                </a>
                <a
                  href={`tel:${websiteInformation.support_number2}`}
                  className="text-lg font-bold mb-10 md:mb-0"
                >
                  {websiteInformation.support_number2}
                </a>
              </div>
              <CustomButton
                buttonType="primary"
          ...
          <div className="mx-auto md:mx-0 flex-1">
            <CustomImage
              src="/assets/images/about_cover.jpg"
              alt={t("about_our_company")}
            />
          </div>
        </div>
      </div>
